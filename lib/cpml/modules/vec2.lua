...
function vec2_mt.__add(a, b)
  precond.assert(vec2.is_vec2(a), "__add: Wrong argument type '%s' for left hand operand. (<cpml.vec2> expected)",
    type(a))
  precond.assert(vec2.is_vec2(b), "__add: Wrong argument type '%s' for right hand operand. (<cpml.vec2> expected)",
    type(b))
  return a:add(b)
end
...
function vec2_mt.__mul(a, b)
  precond.assert(vec2.is_vec2(a), "__mul: Wrong argument type '%s' for left hand operand. (<cpml.vec2> expected)",
    type(a))
  assert(vec2.is_vec2(b) or type(b) == 'number',
    '__mul: Wrong argument type for right hand operand. (<cpml.vec2> or <number> expected)')
...
function vec2_mt.__div(a, b)
  precond.assert(vec2.is_vec2(a), "__div: Wrong argument type '%s' for left hand operand. (<cpml.vec2> expected)",
    type(a))
  assert(vec2.is_vec2(b) or type(b) == 'number',
    '__div: Wrong argument type for right hand operand. (<cpml.vec2> or <number> expected)')
